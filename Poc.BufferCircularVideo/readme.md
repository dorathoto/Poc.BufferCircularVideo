...
Possível fazer com o https://learn.microsoft.com/pt-br/dotnet/api/microsoft.visualstudio.utilities.circularbuffer-1?view=visualstudiosdk-2022
Ou fazer o buffer na mão, como nesse exemplo.
...
OBS: Não teria problema se fosse (10s + trigger + 10s e ao invés de dar 20 segundos desse, 16s ou 22s o que não é aceitavel é ter 1minuto ou mais de diferença))
...
https://github.com/bluenviron/mediamtx/releases/download/v1.11.3/mediamtx_v1.11.3_windows_amd64.zip
...
Depois de executa-lo, execute o comando abaixo para o ffmpeg gerar o conteúdo, pode testar no VLC abrindo em Midia > Abrindo transmissão de REDE > REDE -> "rtsp://localhost:8554/live/stream"
 ...
 ![Exemplo da tela](Captura de tela 2025-04-07 094946.jpg)
...
Use Microsoft.VisualStudio.Utilities.CircularBuffer<T> (recommended).

Or implement a custom buffer (see example code).

Linux Support:
Remove VideoLAN.LibVLC.Windows NuGet package and adapt FFmpeg paths.